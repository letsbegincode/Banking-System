...
public final class BankTestRunner {
    ...
    private void shouldServeHttpApi() {
        ...
        try {
            ...
            assertTrue(accounts.body().contains("\"balance\":1525.00"), "Savings account should reflect post-transfer balance");
            assertTrue(accounts.body().contains("\"balance\":125.00"), "Current account should reflect received transfer");
        } finally {
            server.stop();
            bank.shutdown();
        }
